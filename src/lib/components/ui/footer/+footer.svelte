...
<footer class="bg-white lg:grid lg:grid-cols-5">
    <div class="relative block h-32 lg:col-span-2 lg:h-full">
      <img
        src="https://pub-a45027e3ff724367a0c0f42dd4395e1a.r2.dev/heros2.png"
        alt="footerheroimage"
    ...
    <div class="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
        <div>
          <p>
            <span class="text-xs uppercase tracking-wide text-gray-500"> Email Us </span>

            <a href="https://webstackpros.net" class="block text-2xl font-medium text-gray-900 hover:opacity-75 sm:text-3xl">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            <ul class="mt-6 space-y-4 text-sm">
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Server Renting </a>
              </li>
              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Web Development </a>
              </li>

              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Application Development </a>
              </li>

              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> Marketing Services </a>
              </li>

              <li>
                <a href="#" class="text-gray-700 transition hover:opacity-75"> IT Consulting </a>
              </li>
          ...
          <div>
            ...
            <ul class="mt-6 space-y-4 text-sm">
              ...
              <li>
                <a href="/services" class="text-gray-700 transition hover:opacity-75"> Services </a>
              </li>
      ...
      <div class="mt-12 border-t border-gray-100 pt-12">
        <div class="sm:flex sm:items-center sm:justify-between">
          <ul class="flex flex-wrap gap-4 text-xs">
            <li>
              <a href="/terms-and-conditions" class="text-gray-500 transition hover:opacity-75"> Terms & Conditions </a>
            </li>
